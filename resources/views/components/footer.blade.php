<footer class="bg-white pt-24 pb-12 text-neutral-500 font-light tracking-wide text-sm">
    <div class="max-w-7xl mx-auto px-6">
        ...
        <div class="mb-16 text-center">
            ...
            <p class="text-neutral-500 text-lg mb-8 mx-auto max-w-2xl">
                {{ __('footer.subtitle') }}
            </p>
            ...
            <div class="flex items-center justify-center gap-4">
                ...
                <a href="{{ config('contact.facebook') }}" target="_blank" class="text-[#1877F2] hover:opacity-80 transition-opacity">
                    <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-12 pt-12 border-t border-neutral-100 text-[13px]">
            ...
            <div class="flex flex-col gap-1 items-start md:items-end">
                <a href="#" class="hover:text-black transition-colors">{{ __('footer.cookies') }}</a>
